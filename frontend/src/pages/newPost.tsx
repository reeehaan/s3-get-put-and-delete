...
export default function NewPost() {  
  ...
  const submit = async (event: FormEvent) => {
    ...
    console.log('Submit clicked', { file, caption });
          ...
          <form onSubmit={submit} className="flex flex-col">
            <div className="p-4 border-b border-gray-100 flex justify-center items-center min-h-[300px] bg-gray-50 relative">
               {preview ? (
                  ...
                  <div className="text-center flex flex-col items-center">
                    ...
                    <span className="text-gray-500 text-sm font-medium">Select an image to share</span>
                  </div>
               )}
               <input 
            ...
            <div className="p-4">
              <div className="flex items-start space-x-3">
                <img className="h-8 w-8 rounded-full border border-gray-200 object-cover mt-1" src="https://ui-avatars.com/api/?name=U&background=random" alt="avatar" />
                <textarea 
                  value={caption} 
